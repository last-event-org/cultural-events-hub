...
export default class LoginController {
    ...
    async store({ i18n, session, request, response, auth }) {
        console.log('store');
        try {
    ...
    async requestNewPassword({ response, request, session, i18n }) {
    ...
    async resetPasswordShow({ view }) {
        return view.render('pages/auth/reset-password');
    }
    async resetPasswordStore({ response, request, session, i18n }) {
        const data = {
    ...
    async changePasswordShow({ view }) {
        return view.render('pages/auth/change-password');
    }
    async changePasswordStore({ session, request, response, auth, i18n }) {
