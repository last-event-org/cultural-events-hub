function showSuccessNotification(message) {
  ...
  notification.innerHTML = `
      <div id="toast-success" class="notification fixed bottom-0 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow " role="alert">
...
function showErrorNotification(message) {
  const notification = document.getElementById('notification')
  notification.innerHTML = `
 <div id="toast-danger" class="notification fixed bottom-0 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow " role="alert">
